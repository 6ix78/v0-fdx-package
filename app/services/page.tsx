      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 rounded-2xl overflow-hidden shadow-2xl">
          <Image
            ...
            alt="FedEx delivery services and logistics operations"
            width={1200}
            height={400}
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-white mb-4">Our Shipping Services</h1>
        ...
        {/* Additional Info */}
        <div className="mt-16 glass-card-dark rounded-lg p-8 shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-slate-300">All packages are fully insured and handled with care</p>
            </div>
            <div className="text-center">
              <div className="h-16 w-16 rounded-full bg-blue-100 flex items-center justify-center mx-auto mb-4">
                <Clock className="h-8 w-8 text-blue-600" />
              </div>
              <h3 className="text-lg font-semibold mb-2 text-white">On-Time Delivery</h3>
              <p className="text-slate-300">99.5% on-time delivery rate with money-back guarantee</p>
            </div>
            <div className="text-center">
              <div className="h-16 w-16 rounded-full bg-purple-100 flex items-center justify-center mx-auto mb-4">
                <Globe className="h-8 w-8 text-purple-600" />
              </div>
              <h3 className="text-lg font-semibold mb-2 text-white">Global Network</h3>
              <p className="text-slate-300">Worldwide delivery network covering 220+ countries</p>
            </div>
          </div>
        </div>
      </div>
